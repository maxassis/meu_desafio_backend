export const AccountRecoveryCodeTemplate = (name, code) => {
  return `
  ...
  <body>
    <div class="mail-container">
      ...
      <p class="mail-text1">Recebemos sua solicitação para recuperar o acesso a sua conta no Meu
        desafio app, para continuar informe o código abaixo:
      </p>
